...
import model_fast_transformer as model
import torch
...
parser.add_argument("--attn_type", "-a", type=str, default="ltvc_from_web", help="type of attention")
        ...
        for dep in depth_lst:
            for ff in ff_lst:
                for p in pos_lst:
                    ...
                    transformer = model.CopyModel(device, DIMENTION, NUM_TOKENS, attn_type, DEPTH_enc, DEPTH_dec, HEAD, HEAD, ff_hidnum, position_max_len).to(device)
